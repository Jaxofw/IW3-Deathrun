...
init()
{
    ...
    level.maps[level.maps.size] = "mp_deathrun_cookie";
    ...
    level.maps[level.maps.size] = "mp_deathrun_islands";
    level.maps[level.maps.size] = "mp_deathrun_liferun";
    level.maps[level.maps.size] = "mp_deathrun_mine";
    ...
    level.maps[level.maps.size] = "mp_deathrun_uncharted";
    ...
    level.maps[level.maps.size] = "mp_dr_anubis";
    level.maps[level.maps.size] = "mp_dr_bananaphone_v2";
    level.maps[level.maps.size] = "mp_dr_beach";
    level.maps[level.maps.size] = "mp_dr_biohazard";
    ...
    level.maps[level.maps.size] = "mp_dr_dawn";
    ...
    level.maps[level.maps.size] = "mp_dr_something";
    ...
    level.maps[level.maps.size] = "mp_dr_volpe";
    level.maps[level.maps.size] = "mp_dr_volpe2";
